...
app.controller('ACHController', ['$scope', '$log','$http', '$filter', '$q', function($scope, $log, $http, $filter, $q) {
	var defaultFileName = "";
...
app.controller('ServiceRequestController', ['$scope', '$http', '$filter', '$q',function($scope, $http, $filter, $q) {
	var defaultFileName = "";
	var deferred = $q.defer();
	...
	$scope.generateServiceRequestReport = function() {
		console.log("Generate service request report");
...
app.controller('OnlineOrderController', ['$scope', '$http', '$filter', '$q', function($scope, $http, $filter, $q) {
	var defaultFileName = "";
	var deferred = $q.defer();
...
app.controller('CommerceController', ['$scope', '$http', '$filter', '$q', function($scope, $http, $filter, $q) {
...
app.directive('modalResult', function() {	
	return {
		restrict: 'AE',
